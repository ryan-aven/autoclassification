# -*- coding: utf-8 -*-
"""
Created on Mon Nov 23 14:35:41 2020
...
vectorizer = CountVectorizer(min_df=11, max_df=.7, stop_words=stopwords.words('english'))
...
print("uploading Random Forest classifier")
...
print("fitting model...")
y_pred = gaussian_bayes.fit(x_train, y_train).predict(x_test)
